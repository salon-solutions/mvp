    ...
    <section className="relative overflow-hidden">
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 py-12 sm:py-16 md:py-32">
        <div className="text-center">
          {/* Badge */}
          <div className="inline-flex items-center gap-2 bg-gradient-to-r from-indigo-50 to-purple-50 text-indigo-600 px-4 sm:px-5 py-2 sm:py-2.5 rounded-full text-sm font-semibold mb-6 sm:mb-8 border border-indigo-100 shadow-sm hover-glow">
            <span className="text-base sm:text-lg">❤️</span>
            {badge}
          </div>

          {/* Main Headline */}
          <h1 className="text-4xl sm:text-5xl md:text-7xl font-black leading-[0.9] mb-4 sm:mb-6 text-gray-900">
          ...
          {/* Subheadline */}
          <p className="text-lg sm:text-xl md:text-2xl text-gray-600 max-w-4xl mx-auto mb-8 sm:mb-12 leading-relaxed px-2">
